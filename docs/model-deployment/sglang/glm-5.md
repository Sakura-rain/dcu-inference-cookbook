...
| 模型  | 参数量 | 上下文 | 量化方式  | 推荐硬件 | 卡数 | 部署方式 |
| ----- | ------ | ------ | --------- | -------- | ---- | -------- |
| GLM-5 |   754B |  128K  | INT4 W4A8 |  BW1000  |   8  |   IFB    |
|       |        |        | INT4 W4A8 |  BW1000  |  32  |    PD    |
|       |        |        | INT8 W8A8 |  BW1100  |   8  |   IFB    |
|       |        |        | INT8 W8A8 |  BW1100  |  24  |    PD    |
|       |        |        |  FP8 W8A8 |  BW1100  |   8  |   IFB    |
|       |        |        |  FP8 W8A8 |  BW1100  |  24  |    PD    |
